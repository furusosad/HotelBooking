                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-title mb-80 text-center">
                                ...
                                <p>If you want cancel the booking, please read our mail for more information.</p>
                                <p></p>
                                <a href="home.html"><img src="${pageContext.request.getContextPath()}/resources/images/bg/thank-you.png" alt=""></a>
                            </div>
                        </div>
                    </div>
                </div>
