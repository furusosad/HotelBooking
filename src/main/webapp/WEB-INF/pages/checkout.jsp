...
<body>
                                        ...
                                        <div class="booking-info-inner">
                                            <form action="<c:url value="/checkoutsuccess" />" method="POST">
                                                <div class="booking-form-list">
                                                    <div class="single-form-part">
                                                        <div class="name mb-15">
                                                            <input name="name" id="inputName" type="text" style="color: black" placeholder="Name">
                                                        </div>
                                                    </div>
                                                    <div class="single-form-part">
                                                        <div class="name mb-15">
                                                            <input name="email" id="inputEmail" type="text" style="color: black" placeholder="Email">
                                                        </div>
                                                    </div>
                                                    <div class="single-form-part">
                                                        <div class="name mb-15">
                                                            <input name="phonenumber" id="inputPhoneNumber" type="text" style="color: black" placeholder="Phone Number">
                                                        </div>
                                                    </div>
                                                    <div class="single-form-part" >
                                                        <div class="name mb-15">
                                                ...
                                                <div class="request-box mt-15">
                                                    <textarea name="note" id="inputSubject" style="color: black" placeholder="Any Specific Request"></textarea> 
                                                </div>
                                                <br>
                                                <br>
                                                <br>
                                                ...
                                                <div class="payment-form-list">
                                                    <div class="single_form">
                                                        <input name="cardname" id="inputCardName" style="color: black" type="text" placeholder="Card Holder Name">
                                                    </div>
                                                    <div class="single_form">
                                                        <input name="cardnumber" id="inputCardNumber" style="color: black" type="text" placeholder="Enter Creadit Card Number">
                                                    </div>
                                                    <div class="single_form">
                                                        <input name="cardmonth" id="inputCardMonth" style="color: black" type="text" placeholder="Enter Creadit Card Number">
                                                    </div>
                                                    <div class="single_form">
                                                        <input name="cardyear" id="inputCardYear" style="color: black" type="text" placeholder="Enter Creadit Card Number">
                                                    </div>
                                                </div>
  ...
  <!-- Placed js at the end of the document so the pages load faster -->
    ...
    window.onload = function() {
        ...
        if (phonenumber !== null) $('#inputPhoneNumber').val(phonenumber);
        ...
        if (cardname!== null) $('#inputCardName').val(cardname);
        
        var cardnumber= sessionStorage.getItem('cardnumber');
        if (cardnumber!== null) $('#inputCardNumber').val(cardnumber);
        
        var cardmonth= sessionStorage.getItem('cardmonth');
        if (cardmonth!== null) $('#inputCardMonth').val(cardmonth);
        
        var cardyear= sessionStorage.getItem('cardyear');
        if (cardyear!== null) $('#inputCardYear').val(cardyear);
    }
    ...
    window.onbeforeunload = function() {
        ...
        sessionStorage.setItem("phonenumber", $('#inputPhoneNumber').val());
        sessionStorage.setItem("subject", $('#inputSubject').val());
        sessionStorage.setItem("cardname", $('#inputCardName').val());
        sessionStorage.setItem("cardnumber", $('#inputCardNumber').val());
        sessionStorage.setItem("cardmonth", $('#inputCardMonth').val());
        sessionStorage.setItem("cardyear", $('#inputCardYear').val());
